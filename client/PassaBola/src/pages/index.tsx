...
export default function Component() {
    ...
    return (
        <div className="bg-background relative flex min-h-dvh w-full flex-col overflow-hidden">
          ...
          <span
              className="mb-4 inline-flex items-center gap-2 rounded-full border border-default-100 bg-default-50 px-3 py-1 text-xs text-default-500">
            <Icon className="text-default-500" icon="solar:bolt-linear" width={16}/>
            Olá
          </span>
                    ...
                    <p className="mt-4 max-w-xl text-base leading-7 text-default-500 sm:text-[18px]">
                        A simple workspace to plan, collaborate, and manage work. Sign in to continue
                        or create a free account to get started in minutes.
                    </p>
                    ...
                    <div className="mt-6 flex w-full flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
                        ...
                        <Button
                            ...
                            endContent={
                                <span
                                    className="bg-default-100 pointer-events-none flex h-[22px] w-[22px] items-center justify-center rounded-full">
                ...
                <div
                    className="pointer-events-none absolute inset-0 top-[-25%] z-10 scale-150 select-none sm:scale-125">
                    <FadeInImage
            ...
            <footer
                className="z-20 mx-auto flex w-full max-w-5xl items-center justify-center gap-6 border-t border-default-100 px-6 py-6 text-sm text-default-500 sm:justify-between">
                <p className="hidden sm:block">© {new Date().getFullYear()} Passa a Bola</p>
            </footer>
...
function Feature({icon, title, children}: FeatureProps) {
    return (
        <div
            className="rounded-large border border-default-100 bg-content1/50 p-4 backdrop-blur supports-[backdrop-filter]:bg-content1/60">
